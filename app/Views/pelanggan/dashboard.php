        ...
        <div class="row py-2 border-bottom">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="<?= site_url('adminctrl/index') ?>" class="rounded-circle bg-light p-2 mx-1">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('<?php echo base_url('asset-pelanggan') ?>/images/pro6.png') no-repeat;background-position: right bottom; background-size: 50%;">
                <div class="row banner-content p-5">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="<?= site_url('/pelangganctrl/datadapur')?>" class="nav-link category-item swiper-slide">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="<?php echo base_url('asset-pelanggan') ?>/images/pro7.png" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
